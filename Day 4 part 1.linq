...
AXMXMSSSSMSMXMASAMXSMMMXAXMAMSASXSMMMSAXMSXXAXMASXSXSMMMSMSMXAMXSXAMSSXMSXSSXXSSMMMSAMXSXMSAAXSASMSMXSASMSXMASMSSMXMAMMAMXASASXMASAXSAMXXMAS";
	...
	for(var x = 0; x < rows.Length; ++x)
	{
		...
		{
			numMatches += NumImmediateMatches(rows, x, y, "XMAS", Direction.VerticalUp);
			numMatches += NumImmediateMatches(rows, x, y, "XMAS", Direction.VerticalDown);
			numMatches += NumImmediateMatches(rows, x, y, "XMAS", Direction.HorizontalLeft);
			numMatches += NumImmediateMatches(rows, x, y, "XMAS", Direction.HorizontalRight);
			numMatches += NumImmediateMatches(rows, x, y, "XMAS", Direction.DiagonalUpLeft);
			numMatches += NumImmediateMatches(rows, x, y, "XMAS", Direction.DiagonalUpRight);
			numMatches += NumImmediateMatches(rows, x, y, "XMAS", Direction.DiagonalDownLeft);
			numMatches += NumImmediateMatches(rows, x, y, "XMAS", Direction.DiagonalDownRight);
		}
	}
